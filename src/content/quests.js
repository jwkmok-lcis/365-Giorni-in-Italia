...
export const QUESTS = {
  ...
  q_day10_milk_note: {
    id: "q_day10_milk_note",
    title: "La Nota sul Latte",
    description: "Elena ha trovato un secondo fascicolo con una riga sbiadita. Il Prof. Conti può decifrarla.",
    dayMin: 10,
    dayMax: 11,
    objectives: [
      { type: "talkToNpc", npcId: "elena_bianchi", completed: false },
  ...
  q_day17_soffritto_order: {
    id: "q_day17_soffritto_order",
    title: "Il Vino e il Segreto",
    description: "Lucia e Donna Rosa parlano di vino — ma Lucia fa un'allusione importante. Poi Donna Rosa lo conferma.",
    dayMin: 17,
    dayMax: 18,
    objectives: [
      { type: "talkToNpc", npcId: "lucia_ferrante", completed: false },
    ...
    rewards: { clueId: "clue_segreto_latte", xp: 40 }
  },
  q_day18_wine_debate: {
    id: "q_day18_wine_debate",
    title: "La Nota Marginale",
  ...
  q_day20_confession: {
    id: "q_day20_confession",
    title: "La Confessione",
    description: "Donna Rosa ha qualcosa da dire — qualcosa che non ha detto a nessuno. Poi parla con Giorgio della fiamma.",
    dayMin: 20,
    dayMax: 21,
    objectives: [
      { type: "talkToNpc", npcId: "donna_rosa", completed: false },
  ...
  q_day23_broth_control: {
    id: "q_day23_broth_control",
    title: "Il Tempo",
    description: "Elena e Donna Rosa discutono del tempo di cottura. Confronta le loro visioni.",
    dayMin: 23,
    dayMax: 24,
    objectives: [
      { type: "talkToNpc", npcId: "elena_bianchi", completed: false },
  ...
  q_day27_balance_ratios: {
    id: "q_day27_balance_ratios",
    title: "Il Quaderno Ferrante",
    description: "Il Prof. Conti ha trovato un quaderno secondario di Maria Ferrante. Elena lo aiuta a leggere.",
    dayMin: 27,
    dayMax: 28,
    objectives: [
      { type: "talkToNpc", npcId: "prof_conti", completed: false },
  ...
  q_day28_ferrante_notebook: {
    id: "q_day28_ferrante_notebook",
    title: "La Formula",
    description: "Marco, Lucia ed Elena scrivono la formula finale insieme.",
    dayMin: 28,
    dayMax: 29,
    objectives: [
      { type: "talkToNpc", npcId: "marco_verdini", completed: false },
  ...
  q_day29_final_formula: {
    id: "q_day29_final_formula",
    title: "L'Approvazione",
    description: "Elena porta il dossier a Donna Rosa, Marco e Giorgio per l'approvazione finale. Il Prof. Conti coordina.",
    dayMin: 29,
    dayMax: 30,
    objectives: [
      { type: "talkToNpc", npcId: "elena_bianchi", completed: false },
